...
* Wednesday, June 2, 8:00 -- 9:00 PM. Read [Chapter 1 Visualization](https://ppbds.github.io/primer/visualization.html) and the first two parts of the Appendix on [Tools](https://ppbds.github.io/primer/tools.html): "Working with the terminal" and "Git, GitHub, and RStudio." Complete Visualization A and Visualization B tutorials. 

* Thursday, June 3, 8:00 -- 9:00 PM. Complete Visualization C, Visualization D, and Git/Github tutorials.  
...
* Monday, June 7, 8:00 -- 9:15 PM.  Read [Chapter 2 Wrangling Data](https://ppbds.github.io/primer/wrangling.html). Complete Wrangling A.

* Wednesday, June 9, 8:00 -- 9:15 PM. Read "How to Get Help" from the Appendix on [Tools](https://ppbds.github.io/primer/tools.html). Complete Wrangling B, C, D and Terminal.

* Thursday, June 10, 8:00 -- 9:15 PM. Optional lecture and catch up session. Supervised by course teaching fellows.
...
* Monday, June 14, 8:00 -- 9:15 PM.  Read [Chapter 3 Data](https://ppbds.github.io/primer/data.html). Complete Data A.

* Wednesday, June 16, 8:00 -- 9:15 PM.  Complete Data A, Data Webscraping and Data API.

* Thursday, June 17, 8:00 -- 9:15 PM. Optional lecture and catch up session. Supervised by course teaching fellows.
