...
* Complete Data tutorials: Files, API, and Webscraping
...
* Complete the Distill tutorial and place a (rough!) graphic using the data for your final project in the #final-project Discord channel.
