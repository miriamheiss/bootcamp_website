//Generated:2022-07-27 17:48:33// 39-533
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_6014869 || '',
    GUID: window.ftGUID_6014869 || '99999999999',
    confID: window.ftConfID_6014869 || '0',
    ftReturn: window.ftReturn_6014869 || '',
    keyword: window.ftKeyword_6014869 || '',
    ftId: window.ftId_6014869 || '',
    imp: window.ftImp6014869,
    ftImpId: window.ftImp6014869 && window.ftImp6014869.impID || '',
    gdpr: window.ftImp6014869 && window.ftImp6014869.gdpr || '',
    gdpr_consent: window.ftImp6014869 && window.ftImp6014869.gdpr_consent || '',
    gdpr_pd: window.ftImp6014869 && window.ftImp6014869.gdpr_pd || '',
    us_privacy: window.ftImp6014869 && window.ftImp6014869.us_privacy || '',
    campaignID: '166410',
    cID: '155361',
    pID: '6014869',
    creativeID: '3895402',
    exttrack: [
      'https://dpm.demdex.net/ibs:dpid=3047&dpuuid=[%FT_GUID%]&','https://d.agkn.com/pixel/4068/?che=[%FT_RANDOM%]&aid=12345&cvid=[%FT_CONFID%]&cd1=[%esid!]&cd2=[%epid!]&col=166410,6060,6014869,0,3895402,[%FT_IMPRESSIONID%],[%IDFA%]&puid=[%FT_GUID%]'
    ],
    extscript: [
      ""
    ],
    clickTags: [
      "http://servedby.flashtalking.com/click/8/166410;6014869;3895402;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://d.agkn.com/pixel/4069/?che=[%FT_RANDOM%]&aid=12345&cvid=[%FT_CONFID%]&cd1=[%esid!]&cd2=[%epid!]&col=166410,6060,6014869,0,3895402,[%FT_IMPRESSIONID%],[%IDFA%]&l0=https://www.xfinity.com/learn/internet-service/deals?dfaid=4053494&cmp=0&cid=4053494"
    ],
    placementDescription: 'CORPQ12022BAUNEDNONDT6014869FT728x90',
    width: 728,
    height: 90,
    ...
    divID: 'ftdiv6014869',
    phID: 'ftpos6014869',
    frameID: 'ftframe6014869',
    expID: 'ftexpframe6014869',
    altImgID: 'ftalt6014869',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'http://servedby.flashtalking.com/click/8/166410;6014869;3895402;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://d.agkn.com/pixel/4069/?che=[%FT_RANDOM%]&aid=12345&cvid=[%FT_CONFID%]&cd1=[%esid!]&cd2=[%epid!]&col=166410,6060,6014869,0,3895402,[%FT_IMPRESSIONID%],[%IDFA%]&l0=https://www.xfinity.com/learn/internet-service/deals?dfaid=4053494&cmp=0&cid=4053494',
    altImg: 'http://servedby.flashtalking.com/imp/8/166410;6014869;204;gif;XfinityUS;CORPQ12022BAUNEDNONDT6014869FT728x90/?',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/166410;6014869;271;pixel;XfinityUS;CORPQ12022BAUNEDNONDT6014869FT728x90/?',
    stump: 'http://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/601/6014869/3895402/js/j-6014869-3895402.js',
    file: 'http://cdn.flashtalking.com/155361/3895402/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?222305726-6014869;3895402;',
    adVis: true ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_6014869 || '',
    segmentList: window.ftSegmentList_6014869 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp6014869 && window.ftImp6014869.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m6014869') && /^https:/.test(document.getElementById('ftscript_m6014869').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m6014869'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_6014869'],
      ['ftcfid', 'ftConfID_6014869'],
      ['fttime', 'ftTimestamp_6014869'],
      ['ftsection', 'ftSection_6014869'],
      ['ftcustom', 'ftCustom_6014869'],
      ['ft_id', 'ftId_6014869'],
      ['ftimpid', 'ftImp6014869', 'impID'],
      ['gdpr', 'ftImp6014869', 'gdpr'],
      ['gdpr_consent', 'ftImp6014869', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp6014869', 'gdpr_pd'],
      ['us_privacy', 'ftImp6014869', 'us_privacy']
    ]
  };
...
ft6014869.addEventListener("start",function(){
  //var usrSegs= "u0r,u0u,uyt,123".split(','),
  var usrSegs = (window.ftSegment_6014869 !== "") ? window.ftSegment_6014869.split(","): [],
   matched = [],
   getCCSegs = getCCSegs();
...
(function(ft){
    ...
    ft.viewableImpression = "http://servedby.flashtalking.com/imp/8/166410;6014869;202;pixel;XfinityUS;CORPQ12022BAUNEDNONDT6014869FT728x90/?ft_creative=3895402&ft_configuration=";
    ft.viewableConversion = "true"==="true";
